...
<form action="registeraction.php" method="post"> 
    <table border="0"> 
        ...
        <tr>
            <td>重复密码：</td> <td><input type="password" id="re_password" name="re_password" required="required"></td> 
        </tr>
        <tr> 
            <td colspan="2"> <input type="checkbox" id="admin" name="admin"><small>是否登记为管理员</td> 
        </tr>
        <tr>
            <tr> 
